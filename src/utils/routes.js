...
export const ADMIN_SPECOFFERSPAMLIST = '/admin/specofferspamlist'
export const ADMIN_SPECOFFERS = '/admin/specoffers'
...
export const adminRoutes = [
    ...
    {
        path: ADMIN_SPECOFFERS,
        Component: AdminSpecOffers
    },
    {
