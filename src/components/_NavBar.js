            ...
            <div className="navbar-collapse collapse justify-content-stretch" id="navbar6">
                ...
                <Nav className="me-auto">
                    ...
                    <NavDropdown title="Мои">
                        ...
                        <NavDropdown.Divider>ДЕлитель</NavDropdown.Divider>
                        ...
                        <NavDropdown.Item onClick={()=>activeLink(QUESTFROMME)}className={active===QUESTFROMME ? "active" : ""}>Вопросы от меня</NavDropdown.Item>
